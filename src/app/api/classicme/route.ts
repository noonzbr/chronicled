...
const PROMPTS: Record<string, string> = {
  romeo: `Write a 3-paragraph satirical passage in Shakespeare's romantic voice about a person named {name}.
...
Romantic and gently roasting at once. Lush sentences. About 200 words.`,
  ...
  odyssey: `Write a 3-paragraph satirical passage in Homer's epic Homeric style about a person named {name}.
...
The obstacles are bureaucratic, not mythological. Keep the gravitas; make the subject absurd. Quotable and funny. About 200 words.`,
  ...
  carol: `Write a 3-paragraph satirical passage in Charles Dickens' warm, moralistic voice about a person named {name}.
...
Warm, funny, genuinely human at the end. At least one spectral visitor from {name}'s past. About 200 words.`,
  ...
  monte: `Write a 3-paragraph satirical passage in Alexandre Dumas' theatrical, sweeping voice about a person named {name}.
...
{name} endured, planned, and ultimately triumphed. The revenge is elegant and mild. The prose is impossibly dramatic about something proportionally smaller. About 200 words.`,
  ...
  jane: `Write a 3-paragraph satirical passage in Charlotte Brontë's first-person voice, as if {name} themselves are narrating.
...
Fierce, warm, a little funny. The narrator will not be managed. About 200 words.`,
  ...
  women: `Write a 3-paragraph satirical passage in Louisa May Alcott's warm, wise, nostalgic voice about a person named {name}.
...
Tender and gently comic. The narrator loves {name} enormously and wants to record everything. About 200 words.`,
  ...
  heights: `Write a 3-paragraph satirical passage in Emily Brontë's wild, gothic, elemental voice about a person named {name}.
